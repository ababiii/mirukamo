...
#award_nba_Layer .bt_close {
	...
	<!--// 레이어팝업(2018국가브랜드대상) -->
	<script type="text/javascript"
		src="<c:url value = "/module/examplayer/js/starplayer_config.js"/>"></script>
	<script type="text/javascript"
		src="<c:url value = "/module/examplayer/js/starplayer.js"/>"></script>
	<script type="text/javascript"
		src="<c:url value = "/module/examplayer/js/starplayer_popup.js"/>"></script>
	<script type="text/javascript"
		src="<c:url value = "/module/examplayer/js/starplayer_play.js"/>"></script>
	<script type="text/javascript"
		src="<c:url value = "/resources/jQuery/imgLiquid-min.js"/>"></script>
