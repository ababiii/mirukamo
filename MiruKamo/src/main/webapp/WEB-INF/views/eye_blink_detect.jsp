...
<html>
	...
	<body>
		...
		<script src="../resources/js/eye_track/dat.gul.min.js"></script>
		<script src="../resources/js/eye_track/findeyes.js"></script>
		<script src="../resources/js/eye_track/headtrackr.js"></script>
  ...
  <!-- Monitoring canvas and audio -->  
    ...
    <canvas id="face" width="320" height="240"></canvas>
  	<audio id="audio" src="../resources/audio/Metal_Hit.ogg"></audio>
  	
	<script src="../resources/js/eye_track/blinktracker.js"></script>
<script>
