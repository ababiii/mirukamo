...
<link type="text/css" href="<c:url value = "/resources/css/japan_style.css?1524476367"/>" rel="stylesheet">
...
<script type="text/javascript" src="<c:url value = "/resources/jQuery/jquery.bxslider.min.js"/>"></script>
<script type="text/javascript" src="<c:url value = "/resources/jQuery/jquery.cookie.js"/>"></script>
<script type="text/javascript" src="<c:url value = "/resources/jQuery/japan_script.js?1524476367"/>"></script>
<script type="text/javascript" src="<c:url value = "/resources/jQuery/flashView.js?1524476367"/>"></script>
<script type="text/javascript" src="<c:url value = "/resources/jQuery/imgLiquid-min.js"/>"></script>
<script type="text/javascript" src="<c:url value = "/resources/jQuery/main.js?1524476367"/>"></script>
...
<div id="siwon_header">
	<div id="header_top" class="sec_login">
		<h1 class="logo">
			<a href="./"><img src="<c:url value = "/resources/images/mirukamo3.jpg"/>" alt="mirukamo" width="200px" /></a>
		</h1>
...
<!--// 레이어팝업(2018국가브랜드대상) --><script type="text/javascript" src="<c:url value = "/module/examplayer/js/starplayer_config.js"/>"></script>
<script type="text/javascript" src="<c:url value = "/module/examplayer/js/starplayer.js"/>"></script>
<script type="text/javascript" src="<c:url value = "/module/examplayer/js/starplayer_popup.js"/>"></script>
<script type="text/javascript" src="<c:url value = "/module/examplayer/js/starplayer_play.js"/>"></script>
<script type="text/javascript" src="<c:url value = "/resources/jQuery/imgLiquid-min.js"/>"></script>
